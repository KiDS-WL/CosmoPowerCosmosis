...
sigma8 =      np.linspace(0.39,    1.01,    n_samples)
log_T_AGN =      np.linspace(6.5,      9.36,    n_samples)
z = np.linspace(0.0,      6.0,    n_samples)

#LHS grid

AllParams = np.vstack([omch2, obh2, h, ns, sigma8, z, log_T_AGN])
