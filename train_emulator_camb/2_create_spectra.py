...
def spectra_generation_mead2020_feedback(params):
    ...
    try:
        ...
        np.savez('powerspectra/'+version+'_mead2020_feedback_spectra_'+str(int(params[0])),Plin=Plin,boost=boost)
...
def spectra_generation_mead(params):
    ...
    try:
        ...
        np.savez('powerspectra/'+version+'_mead_spectra_'+str(int(params[0])),Plin=Plin,boost=boost)
