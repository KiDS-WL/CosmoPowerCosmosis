...
def setup(options):
    ...
    config['lin_matter_power_cp'] = cp.cosmopower_NN(restore=True, 
                            restore_filename=os.path.join(path_2_trained_emulator+'/lin_matter_power_emulator_mead2020_feedback'))

    config['nl_matter_power_boost_cp'] = cp.cosmopower_NN(restore=True, 
                            restore_filename=os.path.join(path_2_trained_emulator+'/boost_matter_power_emulator_mead2020_feedback'))
